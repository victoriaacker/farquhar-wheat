...
FARQUHARWHEAT_ELEMENTS_INPUTS = ['width', 'height', 'Eabs', 'nitrates', 'amino_acids', 'proteins', 'Nstruct', 'green_area']
...
FARQUHARWHEAT_ELEMENTS_OUTPUTS = ['PARa', 'Ag', 'An', 'Rd', 'Tr', 'Ts', 'gs', 'width', 'height']
